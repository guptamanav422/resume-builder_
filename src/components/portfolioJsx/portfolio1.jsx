...
import "../portfolioCss/portfolio1.css";
import { firestore } from "../../firebase";
import { useParams } from "react-router";

let Portfolio1 = (props) => {
            ...
            <ul>
              <li>
                <a href="#hero" class="nav-link scrollto active">
                  <i class="bx bx-home"></i> <span style={{color:"white"}}>Home</span>
                </a>
              </li>
              <li>
                <a href="#about" class="nav-link scrollto">
                  <i class="bx bx-user"></i> <span style={{color:"white"}}>About</span>
                </a>
              </li>
              <li>
                <a href="#skills" class="nav-link scrollto">
                  <i class="bx bx-book-content"></i> <span style={{color:"white"}}>Education </span>
                </a>
              </li>
              <li>
                <a href="#resume" class="nav-link scrollto">
                  <i class="bx bx-file-blank"></i> <span style={{color:"white"}}>Resume</span>
                </a>
              </li>
              <li>
                <a href="#contact" class="nav-link scrollto">
                  <i class="bx bx-envelope"></i> <span style={{color:"white"}}>Contact</span>
                </a>
              </li>
            </ul>
          </nav>
