...
let Portfolio2 = () => {
    ...
    let {schoolName10,schoolMarks10,schoolName12,schoolMarks12,CollegeName,degree,collegeMarks ,skills} =  useSelector((state) => state.education);
  ...
  return (
    <div style={{width: "45%" ,position: "relative",left: "55%",backgroundColor:"#5aacb7"}}>
      <div id="page-top">
        {/* <!-- Navigation--> */}
        <nav
        ...
        <div class="container-fluid p-0">
          {/* <!-- About--> */}
          <section class="resume-section" id="about" style={{display:"flex" ,justifyContent:"center", alignItems:"center" ,paddingLeft:"3rem"}}>
